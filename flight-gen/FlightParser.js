...
FlightParser.FunctionExpressionContext = FunctionExpressionContext;
...
FlightParser.prototype.arrayLiteral = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 21)) & ~0x1f) == 0 && ((1 << (_la - 21)) & ((1 << (FlightParser.Function - 21)) | (1 << (FlightParser.Array - 21)) | (1 << (FlightParser.BlockOpen - 21)) | (1 << (FlightParser.ParameterListOpen - 21)) | (1 << (FlightParser.ArrayLiteralOpen - 21)) | (1 << (FlightParser.New - 21)) | (1 << (FlightParser.Identifier - 21)) | (1 << (FlightParser.Boolean - 21)) | (1 << (FlightParser.String - 21)) | (1 << (FlightParser.Number - 21)))) !== 0)) {
            this.state = 355;
            this.elementList();
        }
